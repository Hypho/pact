...
查看 [examples/todo-feature](./examples/todo-feature/)：它展示了一个可运行的已完成功能流程，包括 PID、归档 contract、verify 记录、shipped 后的 state 和一个小测试。
...
| 版本 | 日期 | 核心变更 |
|------|------|---------|
| v1.7.0 | 2026-04-28 | 新增 Python 包发布支持、`pact doctor`、自动安装模式识别，以及 PyPI 发布自动化 |
